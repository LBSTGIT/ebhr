document.addEventListener("DOMContentLoaded", function () {
    ...
    function populateEmployeeDropdown() {
        ...
        dropdown.innerHTML = '<option value="">Select an Employee</option>'; // Default option
    ...
    // Update Employee Details & Dependent Table
    function updateEmployeeDetails() {
        ...
        calculateTotal(); // Auto-update total premium
    }
    ...
    // Update Active_Master JSON Data
    ...
    // Attach Calculation & Update Events
